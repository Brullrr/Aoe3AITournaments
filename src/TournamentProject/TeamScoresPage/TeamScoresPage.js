    ...
    const openCountryProfileHandler = (e) => {
        ...
        setModal(<div className={classes.ModalBody}>
                    ...
                    <div className={classes.Modal} style={{
                        ...
                        <p>Win Percentage: {Math.floor((e.teamWins)/(e.teamLosses + e.teamWins)*100).toFixed(0)} %</p>
        ...
        <div className={classes.Body}>
            ...
            {modalIsOpen ? modal : <div className={classes.Holder}>
                <div className={classes.RegionHolder} >
                    ...
                    }} >Africa:<br/> {(teamData[0].teamElo/4).toFixed(0)}<div className={classes.WinBar} style={{
                ...
                <div style={{
                    height: (60*( ((teamData[1].teamElo/4)*3) - 2500) /1000) + 'vh',
                    marginTop:  60 - (60*( ((teamData[1].teamElo/4)*3) - 2500) /1000) +  'vh'
                }}>Asia: <br/> {(teamData[1].teamElo/4).toFixed(0)} 
                ...
                }}>Southern Europe:<br/> {(teamData[2].teamElo/4).toFixed(0)}
                <div className={classes.WinBar} style={{
                ...
                }}>Northern Europe:<br/> {(teamData[3].teamElo/4 ).toFixed(0) }
                <div className={classes.WinBar} style={{
                ...
                }}>North America:<br/> {(teamData[4].teamElo/3).toFixed(0)}
                <div className={classes.WinBar} style={{
                ...
                }}>Latin America:<br/> {(teamData[5].teamElo/3).toFixed(0)}
                <div className={classes.WinBar} style={{
